    ...
    t.EditOnGithubPlugin = {}, t.EditOnGithubPlugin.create = function(n, i, e) {
        function u(t) {
            return header = ['<div style="overflow: auto">',
                ...
                'onclick="EditOnGithubPlugin.onClick(event)">', '<img alt="memo" src="https://github.githubassets.com/images/icons/emoji/memo.png" class="emoji"> &nbsp', t, "</a></p>", "</div>"
            ].join("")
        }
        return e = e || "Edit on github", i = i || n.replace(/\/blob\//, "/edit/"), t.EditOnGithubPlugin.editDoc =
            function(t, n) {
                var e = n.route.file;
                if (e) {
                    var u = i + e;
